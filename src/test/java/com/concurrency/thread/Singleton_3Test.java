...
import com.design.pattern.singleton.Singleton_3;

import org.testng.annotations.Test;

/**
 * Unit Test for {@link Singleton_3}.
 *
 * @author	lihg
 * @version 2014-1-7
 */
public class Singleton_3Test {
	...
	public void getInstance() throws InterruptedException {
		MockMultiThreads.run(10, new SingletonRunnable());
		
		// 验证实例永远只有1个
		assertEquals(Singleton_3.getInstance().getInstanceCount(), 1);
	}
